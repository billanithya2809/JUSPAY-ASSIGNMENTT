...
const CustomGotoXY = ({ character, comp_id }) => {
  ...
  const handleGotoXY = () => {
    ...
    if (elementToMove) {
      ...
      elementToMove.style.left = state.goto_x + "px";
      elementToMove.style.top = state.goto_y + "px";
    }
  };
...
export default connect(mapStateToProps)(CustomGotoXY);
